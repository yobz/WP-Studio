...
type ButtonBaseProps = Omit<ButtonPrimitive.Props, "size"> &
  Pick<VariantProps<typeof buttonVariants>, "variant"> & { loading?: boolean };

type ButtonProps =
  | (ButtonBaseProps & { size: IconOnlyButtonSize; "aria-label": string })
  | (ButtonBaseProps & { size?: LabeledButtonSize });
