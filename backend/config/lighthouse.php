...
return [
    ...
    */
    ...
    // Route registration is disabled — this project registers `/api/v1/graphql`
    // manually in routes/api_v1.php instead, inside the same auth:sanctum +
    // ResolveCurrentWorkspace middleware group every other route already uses,
    // rather than a special-cased top-level `/graphql` route with its own
    // middleware list. See docs/adr/0011-graphql-layer.md.
    'route' => false,
